...
clang-format -i --files=./clang-format nogui/src/nogui/nogui.cpp
clang-format -i --files=./clang-format nogui/include/nogui/nogui.hpp
clang-format -i --files=./clang-format nogui/include/nogui/options.hpp
clang-format -i --files=./clang-format gui/include/gui/Settings.hpp
clang-format -i --files=./clang-format gui/include/gui/MainWindow.hpp
clang-format -i --files=./clang-format gui/include/gui/AxisTag.hpp
clang-format -i --files=./clang-format gui/src/gui/Settings.cpp
clang-format -i --files=./clang-format gui/src/gui/AxisTag.cpp
clang-format -i --files=./clang-format gui/src/gui/MainWindow.cpp
clang-format -i --files=./clang-format tests/nogui.hpp
