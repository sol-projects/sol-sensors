...
clang-format -i --files=./clang-format gui/include/gui/settings.h
clang-format -i --files=./clang-format gui/include/gui/mainwindow.h
clang-format -i --files=./clang-format gui/include/gui/axistag.h
